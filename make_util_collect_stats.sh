...
UTILSDIR='/home/pbaljeka/TRIS_Exps3/utils-clb/'
VOXDIR='/home/pbaljeka/TRIS_Exps3/cmu_us_clb/festival/'
...
##cat $UTILSDIR/clb.tris |awk '{print $1}'|grep -v "L"|sort|uniq >$UTILSDIR/nodenames
##cat $UTILSDIR/clb.tris |grep "L"|awk '{print $2, $1}'|sort|uniq|sed 's+L++g' |sort -n> $UTILSDIR/senone_numbers
...
do
    cat $UTILSDIR/clb.tris|awk '$1=="'$i'"' >$VOXDIR/tris/${i}.tris
done
for i in `cat $UTILSDIR/senones`;
do
    f=${i}L
    cat $UTILSDIR/clb.tris|awk '$1=="'$f'"' >$VOXDIR/tris/${i}.tris
done
