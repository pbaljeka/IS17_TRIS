...
##cat ${VOXDIR}../etc/txt.done.data.train.train >$UTILSDIR/train_list
##cat ${VOXDIR}../etc/txt.done.data.train.test >$UTILSDIR/val_list
##cat ${VOXDIR}../etc/txt.done.data.test >$UTILSDIR/test_list
