#!/bin/bash
TREEDIR='/home/pbaljeka/TRIS_Exps2/cmu_us_slt/festival/trees/'
VOICEDIR='/home/pbaljeka/TRIS_Exps2/cmu_us_slt/'
voxname='cmu_us_slt'
...
sed -n 8949p cmu_us_sltcg_mcep.rawparams>patch
sed -i '8949d' cmu_us_slt_mcep.rawparams
sed -i 8948rpatch cmu_us_slt_mcep.rawparams

cat cmu_us_sltcg_mcep.rawparams|cut -d ' ' -f1,2 >f0_st
cat cmu_us_sltcg_mcep.rawparams|cut -d ' ' -f103,104 >v0_st
