...
do
cp $VOXDIR/nn_tris_trees/${i}_.mean ${VOXDIR}/predicted_norm_nn_tris_trees/${model_name}/
cp $VOXDIR/nn_tris_trees/${i}_.std ${VOXDIR}/predicted_norm_nn_tris_trees/${model_name}/
done
...
cp $VOXDIR/nn_tris_trees/zh_3_.mean ${VOXDIR}/predicted_norm_nn_tris_trees/${model_name}/
cp $VOXDIR/nn_tris_trees/zh_3_.std ${VOXDIR}/predicted_norm_nn_tris_trees/${model_name}/
